            ...
            <div className="draggable relative h-full w-full flex-1 items-start border-white/20">
              ...
              >
                ...
                <nav className="flex h-full w-full flex-col px-3" aria-label="Chat history">
                    <div className="px-4 flex grid grid-cols-2  justify-center space-between space-x-4 ">
                        <Link href="/profile" className="hover:bg-[#333537] h-12 w-12 mt-8 p-2.5  hover:rounded-full ">
                            <ArrowLeft className="inline-flex space-x-6 w-6 h-6 "/> 
                        </Link>
                           <AddNewTask/>
                    </div>
      ...
      <div className="relative flex h-full max-w-full flex-1 flex-col overflow-hidden">
        ...
        <main className="relative h-full w-full flex-1 overflow-auto transition-width">
          ...
          >
            ...
            <div className="centered-content flex flex-col text-sm md:pb-9">
            <div className="zero-state-container ">ZERO STATE CONTAINER 
             <h1  className="minimized  bard-hello ">
                <span className="z-20 text-2xl minimized bard-hello-size ng-star-inserted"> 
                   Hello, Nasser 
                </span>
             </h1>
            </div>        
            ...
            <div className="md:pt-0 dark:border-white/20 md:border-transparent md:dark:border-transparent w-full">
              <div>
                ...
                <div className="relative w-full px-2 py-2 text-center text-xs text-token-text-secondary empty:hidden md:px-[60px]">
                  <div className="min-h-4 mt-8">
                    <div>Enter new tasks and save submit to save.</div>
                  </div>
                </div>
              </div>
            </div>
...
export const SecondaryMobileHeader = () => {
    return   <div className="draggable sticky top-0 z-10 flex min-h-[60px] items-center justify-center border-transparent bg-token-main-surface-primary pl-0 md:hidden">
    ...
    <div className="no-draggable">
      ...
      >
        <div className="text-token-text-secondary">
          Give it done <span className="text-token-text-secondary">1.o</span>
        </div>
        <svg
          width={24}
          height={24}
