...
const fileUploadSchema = z.object({
  fileUrl: z.string().optional(), // Assuming fileUrl is a string or undefined
});

interface UploadFileFormProps {
  fileUrl: string; // Or `string | undefined` depending on your use case
...
export default function UploadFileForm({ fileUrl, setFileUrl, title, openUploader, closeUploader }:UploadFileFormProps) {
