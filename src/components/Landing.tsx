    ...
    <div className="grid items-end lg:grid-cols-5 gap-8">
      ...
      <div className="grid gap-4 lg:col-span-2">
        <div className="grid gap-4 text-left">
          <h2 className="text-lg text-neutral-400 text-center lg:text-left">Build scalable web applications in 20 minutes with Nasser Sanou a powerful monorepo setup combining Next.js, Nest.js, and Supabase</h2>
        </div>
  ...
  return (
    <footer className="grid gap-8 text-gray-400 py-6 lg:py-12 mb-12 rounded-xl text-center">
      ...
      <div>
        ...
        <p className="text-xs">© 2024 NasDesin. All rights reserved.</p>
      </div>
    </footer>
  );
};
