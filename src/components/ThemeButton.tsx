    ...
    <li  className={clsx("popover_themeSwitcher__HWbbC !mx-4")}>
      ...
      <fieldset 
       className={clsx("!ring-1 !ring-[#4e5155] !border-1 !border-[#4e5155] px-4 tailwind theme-switcher_root__DrzBE popover_themeSwitcherComponent__KfdcZ")}>
        ...
        <span style={{ height: "100%" }} className={clsx(theme === 'light')}>
          <input className={clsx("sr-only")}
            type="radio"
            name="theme"
        ...
        <span style={{ height: "100%" }} >
          ...
          />
          <label htmlFor="theme-switch-dark" className={clsx(theme === 'dark'&& '!ring-1 !ring-[#e5e7eb] !border-1 !border-[#4e5155]')}>
