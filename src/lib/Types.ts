...
export interface ProjectDataType {
  ...
  developers: string[]; // Array of developer IDs
}

export interface ProjectPostDataType {
  title: string;
  description: string;
  long_description?: string; // Optional
  category: string;
...
export interface TaskType {
  ...
  started: boolean;
  in_progress: boolean;
  developer_assigned: string; // Develop
}

export interface ActivityType {
  developer_id: string; // Developer who completed the task
...
export interface NotificationType {
  ...
  recipient_id: string; // Project owner ID
...
export interface UserProps {
  ...
  export type SupabaseUserProfile = {
    ...
    user_role: 'user '| 'developer' | 'owner';
  };
